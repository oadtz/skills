...
- [ ] Backups: confirm PITR/daily backups on the managed DB and run one restore test (forge-operate
      drills this periodically).
- [ ] Migrations tooling initialized; deploys run migrations.
